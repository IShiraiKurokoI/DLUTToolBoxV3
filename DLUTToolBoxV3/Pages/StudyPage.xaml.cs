...
namespace DLUTToolBoxV3.Pages
{
    ...
    public sealed partial class StudyPage : Page
    {
        ...
        {
            WebHelper.AddOrCreateNewPage(new AppDataItem("1", "本周课表", "ms-appx:///Assets/AppIcons/Study/WeekTimeTable.png", "", "https://api.m.dlut.edu.cn/login?client_id=9qXqHnRQuhhViycC&redirect_uri=https%3a%2f%2flightapp.m.dlut.edu.cn%2fcheck%2fcourseschedule&response_type=code", 0));
        }
